//components/playground/RandomJoke.jsx
...
const RandomJoke = () => {
    const [joke, setJoke] = useState("Click the button for a random dev joke.");
    ...
    return (
        <PlaygroundCard title="😂 Random Joke">
            <p>A small break for your brain.</p>
            <button className="run-btn" onClick={getJoke} style={{ width: '100%', marginBottom: '1rem' }}>
                Tell Me A Joke
            </button>
